...
import ${package}.${artifactId}.ui.business.task.AbstractTaskTablePage.Table;
...
public class AbstractTaskTablePage extends AbstractPageWithTable<Table> {
  private static final Logger LOG = LoggerFactory.getLogger(AbstractTaskTablePage.class);
