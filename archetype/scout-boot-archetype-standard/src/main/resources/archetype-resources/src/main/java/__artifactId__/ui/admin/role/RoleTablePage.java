...
import ${package}.${artifactId}.ui.admin.role.ReadAdministrationRolePagePermission;
import ${package}.${artifactId}.ui.admin.role.RoleTablePage.Table;
import ${package}.${artifactId}.ui.admin.text.TranslationForm;
...
public class RoleTablePage extends AbstractPageWithTable<Table> {
  ...
  protected void execInitPage() {
    setVisiblePermission(new ReadAdministrationRolePagePermission());
  }
