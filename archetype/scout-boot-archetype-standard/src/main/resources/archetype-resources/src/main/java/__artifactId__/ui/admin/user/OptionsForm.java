...
import ${package}.${artifactId}.ui.admin.user.OptionsForm.MainBox.ApplyButton;
import ${package}.${artifactId}.ui.admin.user.OptionsForm.MainBox.ChangePasswordBox;
import ${package}.${artifactId}.ui.admin.user.OptionsForm.MainBox.UserBox;
import ${package}.${artifactId}.ui.admin.user.OptionsForm.MainBox.ChangePasswordBox.CancelPasswordChangeLink;
import ${package}.${artifactId}.ui.admin.user.OptionsForm.MainBox.ChangePasswordBox.ChangePasswordLink;
import ${package}.${artifactId}.ui.admin.user.OptionsForm.MainBox.ChangePasswordBox.ConfirmPasswordField;
import ${package}.${artifactId}.ui.admin.user.OptionsForm.MainBox.ChangePasswordBox.NewPasswordField;
import ${package}.${artifactId}.ui.admin.user.OptionsForm.MainBox.ChangePasswordBox.OldPasswordField;
import ${package}.${artifactId}.ui.admin.user.OptionsForm.MainBox.ChangePasswordBox.UpdateLinkButton;
