...
import ${package}.${artifactId}.ui.admin.text.TranslationForm.MainBox.CancelButton;
import ${package}.${artifactId}.ui.admin.text.TranslationForm.MainBox.OkButton;
import ${package}.${artifactId}.ui.admin.text.TranslationForm.MainBox.TopBox;
import ${package}.${artifactId}.ui.admin.text.TranslationForm.MainBox.TopBox.HasTextFilterField;
import ${package}.${artifactId}.ui.admin.text.TranslationForm.MainBox.TopBox.KeyField;
import ${package}.${artifactId}.ui.admin.text.TranslationForm.MainBox.TopBox.LocaleFilterField;
import ${package}.${artifactId}.ui.admin.text.TranslationForm.MainBox.TopBox.TranslationTableField;
import ${package}.${artifactId}.ui.admin.text.TranslationForm.MainBox.TopBox.TranslationTableField.Table;
import ${package}.${artifactId}.ui.admin.user.LocaleLookupCall;
