...
import ${package}.${artifactId}.ui.admin.user.UserForm.MainBox.AccountLockedField;
import ${package}.${artifactId}.ui.admin.user.UserForm.MainBox.CancelButton;
import ${package}.${artifactId}.ui.admin.user.UserForm.MainBox.OkButton;
import ${package}.${artifactId}.ui.admin.user.UserForm.MainBox.PasswordField;
import ${package}.${artifactId}.ui.admin.user.UserForm.MainBox.RoleTableField;
import ${package}.${artifactId}.ui.admin.user.UserForm.MainBox.UserBox;
...
public class UserForm extends AbstractForm {
	...
	private void importUserRoles(User user) {
		RoleTableField.Table table = getRoleTableField().getTable();
		List<String> roles = roleService.getAll().stream().map(r -> r.getId()).collect(Collectors.toList());
