...
import ${package}.${artifactId}.backend.controller.ReadApiPermission;
import ${package}.${artifactId}.backend.entity.UserEntity;
import ${package}.${artifactId}.backend.repository.UserRepository;
...
import ${package}.${artifactId}.ui.business.task.ReadTaskPermission;
import ${package}.${artifactId}.ui.business.task.UpdateTaskPermission;
import ${package}.${artifactId}.ui.business.task.ViewAllTasksPermission;
