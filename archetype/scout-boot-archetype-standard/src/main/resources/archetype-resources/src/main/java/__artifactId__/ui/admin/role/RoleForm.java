...
import ${package}.${artifactId}.ui.admin.role.RoleForm.MainBox.CancelButton;
import ${package}.${artifactId}.ui.admin.role.RoleForm.MainBox.OkButton;
import ${package}.${artifactId}.ui.admin.role.RoleForm.MainBox.RoleBox;
import ${package}.${artifactId}.ui.admin.role.RoleForm.MainBox.RoleBox.PermissionTableField;
import ${package}.${artifactId}.ui.admin.role.RoleForm.MainBox.RoleBox.RoleIdField;
import ${package}.${artifactId}.ui.admin.user.CreateUserPermission;
import ${package}.${artifactId}.ui.admin.user.UpdateUserPermission;
