...
/**
 * ScoutBootBeanFilter to replace Scout's default bean filter. Why do we need this? Scout's default bean filter skips bean
 * classes without a no args constructor. This means that the Desktop class of this app would not be considered a valid
 * bean. ScoutBootBeanFilter is used in {@link ScoutBootPlatform}}
 */
@SuppressWarnings("rawtypes")
public class ScoutBootBeanFilter {
  private static final Logger LOG = LoggerFactory.getLogger(ScoutBootBeanFilter.class);
...
public Set<Class> collect(IClassInventory classInventory) {
  ...
  public ScoutBootBeanFilter withNoArgConstructorRequired(boolean noArgConstructorRequired) {
    m_noArgConstructorRequired = noArgConstructorRequired;
    return this;
  }

  public ScoutBootBeanFilter withIgnoredBeanClass(String ignoredBeanClass) {
